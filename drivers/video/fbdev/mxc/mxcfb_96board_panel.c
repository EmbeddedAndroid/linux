...
#define MX96BOARD_TWO_DATA_LANE					(0x2)
#define MX96BOARD_MAX_DPHY_CLK					(800)
#define MX96BOARD_CMD_GETHXID					(0xF4)
#define MX96BOARD_CMD_GETHXID_LEN					(0x4)
#define MX96BOARD_ID						(0x84)
#define MX96BOARD_ID_MASK						(0xFF)
...
static struct mipi_lcd_config lcd_config = {
	.virtual_ch	= 0x0,
	.data_lane_num  = MX96BOARD_TWO_DATA_LANE,
	.max_phy_clk    = MX96BOARD_MAX_DPHY_CLK,
	.dpi_fmt	= MIPI_RGB888,
};

void mipid_tda_get_lcd_videomode(struct fb_videomode **mode, int *size,
...
int mipid_tda_lcd_setup(struct mipi_dsi_info *mipi_dsi)
{
	...
	dev_dbg(&mipi_dsi->pdev->dev, "MIPI DSI LCD MX96BOARD setup.\n");
