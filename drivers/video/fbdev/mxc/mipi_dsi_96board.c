...
#include <linux/mipi_dsi_96board.h>
...
#define DISPDRV_MIPI			"mipi_dsi_96board"
...
static struct mipi_dsi_match_lcd mipi_dsi_lcd_db[] = {
	{
	 "TRULY-TDA",
	 {mipid_tda_get_lcd_videomode, mipid_tda_lcd_setup}
	},
	{
	"", {NULL, NULL}
	}
